<template>
 <div class="help">
    ...
    <v-container id="instructBox" grid-list-xl>
      <v-layout row wrap align-center>
        <v-flex xs3>
          <v-card id="imageBox">
            <span style="color: rgb(183, 204, 146);">
    ...
    <v-container id="Box" grid-list-xl>
      <v-layout row wrap align-center>
        <v-flex xs11>
          <h2>Contact Us</h2>
        </v-flex>
      ...
      <v-layout row wrap align-center>
        ...
        <v-flex xs4>
          <v-text-field color="white" label="Email"></v-text-field>
        </v-flex>
      </v-layout>
      ...
      <v-layout row wrap align-center>
        ...
        <v-flex xs3>
          <h1>bendy@purdue.edu</h1>
        </v-flex>
        <v-flex xs4>
          <v-text-field color="white" label="Message"></v-text-field>
        </v-flex>
      </v-layout>
...
#instructBox {
  outline: 2px rgb(158, 158, 158);
  box-shadow: 1px 1px 4px 0 rgba(255, 255, 255, 0.103);
  padding: 10px;
  background-color: transparent;
}
#Box {
  background-color: rgb(183, 204, 146);
}
#NameBox {
